...
delegate: Item {
                                ...
                                Rectangle {
                                    ...
                                    radius: 11
                                    color: active ? HubTheme.primary : "transparent"
                                                    }
                                Text {
                                    id: modeText
                                    anchors.centerIn: parent
                                    ...
                                    color: active ? HubTheme.onPrimary : HubTheme.surfaceVariantText
                                                    }
                                MouseArea {
                                    anchors.fill: parent
            ...
            ListView {
                ...
                delegate: Item {
                    ...
                    Rectangle {
                        ...
                        height: 28; radius: 14
                        color: active ? HubTheme.primary : HubTheme.surfaceContainer
                        border.color: active ? HubTheme.primary : HubTheme.outlineVariant
                        border.width: 1
        ...
        Item {
            ...
            Rectangle {
                ...
                Column {
                    ...
                    Text {
                        text: "⚠"; font.pixelSize: 30; color: HubTheme.error
                        anchors.horizontalCenter: parent.horizontalCenter; opacity: 0.8
                    }
                    Text {
                        text: Anime.animeError
                        color: HubTheme.surfaceVariantText; font.pixelSize: 12
                        font.family: browseView.fontBody
                ...
                delegate: Item {
                    ...
                    Rectangle {
                        ...
                        Rectangle {
                            ...
                            color: HubTheme.surfaceContainer; radius: 12
